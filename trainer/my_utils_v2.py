...
class data_generator(DataGenerator):
    """数据生成器
    """
    def __iter__(self, random=False, label2id=None, max_len=None, tokenizer=None):
        batch_token_ids, batch_mask_ids, batch_segment_ids, batch_labels = [], [], [], []
        for is_end, d in self.sample(random):
            ...
            labels = [label2id[itm] for itm in labels]
            batch_token_ids.append(token_ids)
            batch_mask_ids.append(input_mask)
            ...
            if len(batch_token_ids) == self.batch_size or is_end:
                ...
                yield batch_token_ids, batch_mask_ids, batch_segment_ids, batch_labels
                batch_token_ids, batch_mask_ids, batch_segment_ids, batch_labels = [], [], [], []
...
def extract_entities(text,  model, sess, tokenizer, max_len, id2label):
    """arguments抽取函数
    """
