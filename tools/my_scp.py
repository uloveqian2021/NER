...
# remote_path远程服务器目录
# file_path本地文件夹路径
# img_name是file_path本地文件夹路径下面的文件名称 sushaoxunspace/resultdata
...
def upload_file(remote_path="/wang/save_model/ccks2020ee/", file_path="./README.md", is_file=False):
    ...
    # host = "10.10.150.91"  # 服务器ip地址
    # port = 22  # 端口号
    # username = "root"  # ssh 用户名
    # password = "bd@2020"  # 密码

    host = "10.10.177.28"  # 服务器ip地址
    port = 22  # 端口号
    username = "pubuser"  # ssh 用户名
    password = "Boe888888"  # 密码
